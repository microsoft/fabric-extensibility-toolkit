...
# assets
$srcFile = Join-Path  $PSScriptRoot "..\..\Workload\app\assets\items\${srcItemName}\EditorEmpty.svg"
if (Test-Path $srcFile) {
    $targetFile = Join-Path $PSScriptRoot "..\..\Workload\app\assets\items\${itemName}\EditorEmpty.svg"
    Copy-SourceItemFile -SourceFile $srcFile -DestinationFile $targetFile
} else {
